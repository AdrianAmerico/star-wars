...
export const PeoplePage = () => {
  ...
  React.useEffect(() => {
    const getPeople = async () => {
      ...
      const peoplesData = value?.data?.results?.map(({ name, height, mass, birth_year, hair_color, gender, skin_color, films }: IPeople) => {
        return [name, mass, height, hair_color, skin_color, birth_year, gender, films]
      })
